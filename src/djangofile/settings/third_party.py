from djangofile.settings import DEBUG, REDIS_HOST, RABBITMQ_URL
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'djangofile.apis.renderers.DefaultRenderer',
    ),
...
CELERY_TASK_DEFAULT_QUEUE = 'djangofile.celery'
